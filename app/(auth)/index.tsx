...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: '#0d0820' },
  content: { paddingBottom: 52 },

  logoRow: { alignItems: 'center', paddingTop: 28, paddingBottom: 16 },

  headline: {
    fontFamily: Fonts.serif, fontSize: 40, color: Colors.white,
    textAlign: 'center', lineHeight: 46, marginBottom: 12,
    paddingHorizontal: Spacing.lg,
  },
  sub: {
    fontSize: FontSizes.sm, color: 'rgba(210,195,240,0.85)',
  ...
  countdownPill: {
    ...
    alignSelf: 'center',
    backgroundColor: 'rgba(244,114,182,0.1)', borderRadius: Radius.pill,
    paddingHorizontal: 16, paddingVertical: 9, marginBottom: 22,
    borderWidth: 1, borderColor: 'rgba(244,114,182,0.4)',
  },
  pulseDot: { width: 7, height: 7, borderRadius: 3.5, backgroundColor: Colors.pink },
  countdownLabel: { fontSize: FontSizes.xs, color: 'rgba(210,195,240,0.75)' },
  countdownTime: { fontFamily: Fonts.serif, fontSize: FontSizes.md, color: Colors.white, letterSpacing: 1.5 },
  ...
  gridTile: { borderRadius: 14, overflow: 'hidden', position: 'relative' },
  gridFallback: {
    ...StyleSheet.absoluteFillObject, alignItems: 'center', justifyContent: 'center', gap: 5, padding: 6,
  },
  gridFallbackIcon: { fontSize: 30 },
  gridFallbackLabel: { fontSize: 8, color: 'rgba(255,255,255,0.85)', fontWeight: '700', textAlign: 'center' },
  gridImage: { ...StyleSheet.absoluteFillObject as any },
  gridOverlay: {
    ...StyleSheet.absoluteFillObject,
    backgroundColor: 'rgba(12,8,26,0.32)',
  },
  gridPriceBadge: {
    position: 'absolute', top: 7, left: 7,
    backgroundColor: 'rgba(139,92,246,0.85)', borderRadius: 7,
    paddingHorizontal: 7, paddingVertical: 2.5,
  },
  gridPrice: { fontSize: 9.5, color: Colors.white, fontWeight: '800' },
  gridBottom: {
    position: 'absolute', bottom: 8, left: 8, right: 8,
  },
  gridValue: { fontSize: 11, color: Colors.gold, fontWeight: '800', textShadowColor: 'rgba(0,0,0,0.7)', textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 3 },

  gridCaption: {
    textAlign: 'center', fontSize: 10.5, color: 'rgba(210,195,240,0.55)',
    marginBottom: 22, paddingHorizontal: Spacing.lg,
  },

  // Winner card
  winnerCard: {
    marginHorizontal: Spacing.lg, marginBottom: Spacing.lg,
    backgroundColor: 'rgba(10,6,24,0.75)', borderRadius: Radius.xl,
  ...
  winnerHeader: { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 14 },
  winnerDot: { width: 7, height: 7, borderRadius: 99, backgroundColor: Colors.gold },
  winnerHeaderLabel: { flex: 1, fontSize: 9, fontWeight: '800', letterSpacing: 1.5, color: Colors.gold },
  winnerDots: { flexDirection: 'row', gap: 4 },
  winnerDotSmall: { width: 5, height: 5, borderRadius: 99, backgroundColor: 'rgba(255,255,255,0.18)' },
  winnerDotActive: { backgroundColor: Colors.gold },
  winnerBody: { flexDirection: 'row', alignItems: 'center', gap: 14 },
  winnerImg: { width: 60, height: 60, borderRadius: 12, backgroundColor: 'rgba(180,100,160,0.4)', borderWidth: 1, borderColor: 'rgba(249,200,70,0.3)' },
  winnerMeta: { flex: 1 },
  winnerHandle: { fontFamily: Fonts.serif, fontSize: FontSizes.md, color: Colors.white },
  winnerItem: { fontSize: FontSizes.xs, color: Colors.textSecondary, marginTop: 3 },
  winnerPriceRow: { flexDirection: 'row', alignItems: 'center', gap: 7, marginTop: 7 },
  winnerPaid: { fontSize: 10, color: Colors.textTertiary },
  winnerArrow: { fontSize: 10, color: Colors.textTertiary },
  winnerValue: { fontSize: 11, color: Colors.gold, fontWeight: '800' },
  winnerMultipleBox: { alignItems: 'center', paddingLeft: 6 },
  winnerMultiple: { fontFamily: Fonts.serif, fontSize: 26, color: Colors.gold },
  winnerMultipleSub: { fontSize: 8, color: Colors.textTertiary, marginTop: 2 },

  // How it works
  howCard: {
    marginHorizontal: Spacing.lg, marginBottom: Spacing.lg,
    backgroundColor: 'rgba(15,10,30,0.6)', borderRadius: Radius.xl,
    borderWidth: 1, borderColor: 'rgba(139,92,246,0.22)', padding: Spacing.lg, gap: 16,
  },
  howTitle: { fontFamily: Fonts.serif, fontSize: FontSizes.base, color: Colors.white, marginBottom: 2 },
  howRow: { flexDirection: 'row', alignItems: 'center', gap: 14 },
  howNum: { width: 24, height: 24, borderRadius: 12, backgroundColor: 'rgba(139,92,246,0.25)', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: 'rgba(139,92,246,0.4)' },
  howNumText: { fontSize: 10, color: Colors.lilac, fontWeight: '800' },
  howIconBox: { width: 36, height: 36, borderRadius: 10, backgroundColor: 'rgba(139,92,246,0.15)', alignItems: 'center', justifyContent: 'center' },
  howText: { flex: 1 },
  howStepTitle: { fontSize: FontSizes.sm, color: Colors.white, fontWeight: '700' },
  howStepSub: { fontSize: FontSizes.xs, color: 'rgba(210,195,240,0.6)', marginTop: 2, lineHeight: 17 },

  // Trust
  trustRow: {
    flexDirection: 'row', justifyContent: 'space-around', marginBottom: Spacing.xl,
    paddingHorizontal: Spacing.md, paddingVertical: 14,
    backgroundColor: 'rgba(139,92,246,0.06)', marginHorizontal: Spacing.lg,
    borderRadius: Radius.lg, borderWidth: 1, borderColor: 'rgba(139,92,246,0.15)',
  },
  ...
  noCard: { textAlign: 'center', fontSize: 10, color: 'rgba(255,255,255,0.25)', paddingHorizontal: Spacing.lg },
});
